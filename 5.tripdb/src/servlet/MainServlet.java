...
public class MainServlet extends HttpServlet {
		...
		try {
			switch(action) {
				...
				case "reviewDelete" :
					...
					break;
				case "reviewAddLike" :
					reviewAddLike(request, response);
					break;
				case "reviewRemoveLike" :
					reviewRemoveLike(request, response);
					break;
				case "find":
				...
				case "reviewUpdate" :
					...
					break;
				case "executeNotice" :
					executeNoticeUpdate(request, response);
					break;
				case "executeReview" :
					executeReviewUpdate(request, response);
					break;
 			}
		} catch(Exception e) {
			e.printStackTrace();
	...
	protected void login(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException, SQLException {
		...
		if(user!=null && user.getPassword().equals(password) && user.getId().equals(id)) {
			HttpSession session = request.getSession();
