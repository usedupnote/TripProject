...
public class BoardServiceImpl implements BoardService {
	...
	public int updateViewCount(String id) {
		return repo.updateViewCount(id);
	}
	...
	@Override
	public List<Board> selectBoardByCategory(int boardCategoryId) {
		return repo.selectBoardByCategory(boardCategoryId);
	}

	@Override
	public List<Board> getAllStaredBoardByUserEmail(String userEmail) {
		return repo.getAllStaredBoardByUserEmail(userEmail);
	}
}
