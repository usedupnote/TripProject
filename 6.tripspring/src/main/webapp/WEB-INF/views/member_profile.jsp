<%@ page contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
                    ...
                    <div class="card-block text-center text-white">
                      ...
                      <div class="mt-5 text-center">
                        <button class="btn btn-primary profile-button" type="button"
                          onclick="location.href='${root}/member_edit'">
                          수정
                        </button>
                      </div>
                    </div>
                    ...
                    <div class="card-block">
                      ...
                      <div class="row">
                        <div class="col-sm-6">
                          ...
                          <h6 id="userinfo-email" class="text-muted f-w-400">${userinfo.email}</h6>
                        </div>
                        <div class="col-sm-6">
  ...
  <script>
    let userInfoEmail = document.getElementById("userinfo-email");
    userInfoEmail.innerHTML = sessionStorage.getItem("email");
  </script>
