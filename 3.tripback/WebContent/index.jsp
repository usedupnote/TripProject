      ...
      <div class="container position-relative">
        <div class="row gy-5" data-aos="fade-in">
          ...
          <div class="col-lg-6 order-1 order-lg-2">
            <img src="assets/img/icon/aeroplane.png" class="img-icon" alt="" data-aos="zoom-out" data-aos-delay="100" />
          </div>
        </div>
      </div>
          ...
          <div class="row gy-4 mt-5">
            <div class="col-xl-3 col-md-6" data-aos="fade-up" data-aos-delay="100">
              <div class="icon-box">
                ...
                <h4 class="title"><a href="${root}/tripsearch.jsp" class="stretched-link"> 지역별여행지</a></h4>
              </div>
            </div>
            <!--End Icon Box -->
            ...
            <div class="col-xl-3 col-md-6" data-aos="fade-up" data-aos-delay="200">
              <div class="icon-box">
                ...
                <h4 class="title"><a href="${root}/my_trip.jsp" class="stretched-link">나의여행계획</a></h4>
              </div>
            </div>
            <!--End Icon Box -->
            ...
            <div class="col-xl-3 col-md-6" data-aos="fade-up" data-aos-delay="300">
              <div class="icon-box">
                ...
                <h4 class="title"><a href="${root}/sample-inner-page.jsp" class="stretched-link">핫플자랑하기</a></h4>
              </div>
            </div>
            <!--End Icon Box -->
            ...
            <div class="col-xl-3 col-md-6" data-aos="fade-up" data-aos-delay="500">
              <div class="icon-box">
                ...
                <h4 class="title"><a href="${root}/postWrite.jsp" class="stretched-link">여행정보공유</a></h4>
              </div>
            </div>
            <!--End Icon Box -->
          </div>
